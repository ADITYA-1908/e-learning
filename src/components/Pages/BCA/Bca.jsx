...
const courseData = [
  ...
  },
  {
    ...
    enrollUrl: ["https://youtube.com/playlist?list=PLqleLpAMfxGDq9Ehl8FUstcRrCRQPQO7n&feature=shared"]
  },
  {
    id: 7,
  ...
  return (
    <section className="bg-[#112e42] py-6">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center text-[#00abf0] mt-24 mb-12">BCA</h2>
        <p className="mb-6 text-lg text-[#ededed]">
          It provides a comprehensive platform covering all core subjects of BCA, offering the best curated playlists from
